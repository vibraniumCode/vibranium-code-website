<template>
  <section class="pt-4 font-inter text-center text-white to-white relative z-10 m-6">
    ...
    <div> 
      <h1 class="text-black text-2xl font-semibold">Todo lo que podés hacer con <span class="bg-[#4923c6] text-white px-2">VIBRANIUM CODE</span></h1>
    </div>
    <div class="max-w-8xl mx-auto mt-10 px-4 sm:px-6 lg:px-12 xl:px-20">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 xl:gap-10 2xl:gap-14 my-12 text-black text-xl" data-aos="zoom-in">
        <!-- SOFTWARE A MEDIDA -->
        <div class="bg-gray-100 text-green-800 rounded-xl px-10 py-24 border border-green-200 hover:shadow-2xl hover:shadow-green-500/30 hover:-translate-y-1 transition-all duration-300" >
          <div class=" place-items-center">
            <div class="bg-green-500 w-20 h-20 rounded-xl mb-12 flex items-center justify-center">
        ...
        <div class="bg-blue-100/70 text-blue-800 rounded-xl px-10 py-24 border border-blue-200 hover:shadow-2xl hover:shadow-blue-500/30 hover:-translate-y-1 transition-all duration-300">
          <div class="place-items-center ">
            <div class="bg-blue-500 w-20 h-20 rounded-xl mb-12 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="white" viewBox="0 0 24 24">
        ...
        <!-- MANTENIMIENTO -->
        <div class="bg-orange-100/70 text-orange-800 rounded-xl px-10 py-24 border border-orange-200 hover:shadow-2xl hover:shadow-orange-500/30 hover:-translate-y-1 transition-all duration-300">
          <div class="grid place-items-center text-center">
            <div class="bg-orange-500 w-20 h-20 rounded-xl mb-12 flex items-center justify-center ">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="white" viewBox="0 0 24 24">
        ...
        <!-- AUTOMATIZACIONES -->
        <div class="bg-purple-100/70 text-purple-800 rounded-xl px-10 py-24 border border-purple-200 hover:shadow-2xl hover:shadow-purple-500/30 hover:-translate-y-1 transition-all duration-300">
          <div class="grid place-items-center text-center">
            <div class="bg-purple-500 w-20 h-20 rounded-xl mb-12 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="white" viewBox="0 0 24 24">
